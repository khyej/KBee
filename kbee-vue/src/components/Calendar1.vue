  ...
  <div>
    ...
    <div class="grid grid-cols-7 divide-gray-200">
      <div
        ...
        :class="{ 'text-gray-400': day.isPrevMonth || day.isNextMonth }"
      >
        <span
          class="text-xs font-semibold text-gray-500 flex items-center justify-center w-7 h-7 rounded-full"
        >
          {{ day.date }}
        </span>
      </div>
    ...
    <div class="w-full max-w-7xl mx-auto px-4 lg:px-8 xl:px-14">
      ...
      <div class="border border-gray-200">
        <div class="grid grid-cols-7 divide-gray-200 border-b border-gray-200">
          ...
          <div
            class="p-3.5 flex flex-col sm:flex-row items-center justify-between"
          >
        ...
        <div class="grid grid-cols-7 divide-gray-200">
          ...
          >
            <span
              class="text-xs font-semibold text-gray-900 flex items-center justify-center w-7 h-7 rounded-full"
              >1</span
            >
          </div>
          <div
          ...
          >
            ...
            <span class="hidden lg:block text-xs font-medium text-gray-500"
              >Meeting with marketing department</span
            >
          ...
          >
            <span
              class="text-xs font-semibold text-white flex items-center justify-center w-7 h-7 rounded-full bg-indigo-600"
              >12</span
            >
          </div>
          <div
      ...
      <div class="w-full lg:hidden py-8 px-2.5">
        <div class="bg-gray-50 w-full rounded-xl">
          <div
            class="p-3 w-full flex items-center justify-between group transition-all duration-300"
          >
            <div class="flex flex-col gap-2">
              <span class="text-sm font-medium text-gray-900"
                >Meet with friends</span
              >
            ...
            <button
              class="py-1 px-2 rounded border border-gray-400 text-xs font-medium text-gray-900 opacity-0 transition-all duration-500 group-hover:opacity-100"
            >
              Edit
            </button>
          </div>
